...
public class WriteJsonToFileInJava {
    ...
    static void methodWriteJSONtoFileInJava(){
        ...
        signAquariusDetails.put("information","Element: Air Strengths: Progressive, original, independent, humanitarian Weaknesses: Runs from emotional expression, temperamental, uncompromising, aloof\n" +
        ...
        singAquariusObject.put("aquarius",signAquariusDetails);

        // 2 Sign is pisces
        JSONObject singPiscesDetails= new JSONObject();
        singPiscesDetails.put("date_range","02.19 - 03.20");
        singPiscesDetails.put("information","Element: Water/Strengths: Compassionate, artistic, intuitive, gentle, wise, musical. Weaknesses: Fearful, overly trusting, sad, desire to escape reality, can be a victim or a martyr\n" +
        ...
        signPiscesObject.put("pisces",singPiscesDetails);

        // 3 Sign is aries
        JSONObject signAriesDetails = new JSONObject();
        signAriesDetails.put("date_range","03.21 - 04.19");
        signAriesDetails.put("information","Element: Fire/Strengths: Courageous, determined, confident, enthusiastic, optimistic, honest, passionate Weaknesses: Impatient, moody, short-tempered, impulsive, aggressive\n" +
        ...
        signAriesObject.put("aries",signAriesDetails);

        // 4 Sign is taurus
        JSONObject signTaurusDetails = new JSONObject();
        signTaurusDetails.put("date_range"," 04.20 - 05.20");
        signTaurusDetails.put("information","Strengths: Reliable, patient, practical, devoted, responsible, stable\n" +
        ...
        signTaurusObject.put("taurus",signTaurusDetails);

        // 5 Sign is gemini
        JSONObject signGeminiDetails = new JSONObject();
        signGeminiDetails.put("date_range"," 05.21 - 06.20 ");
        signGeminiDetails.put("information","Strengths: Gentle, affectionate, curious, adaptable, ability to learn quickly and exchange ideas. Weaknesses: Nervous, inconsistent, indecisive. Gemini likes: Music, books, magazines, chats with nearly anyone, short trips around the town. Gemini dislikes: Being alone, being confined, repetition and routine. \n" +
        ...
        signGeminiObject.put("gemini",signGeminiDetails);

        // 6 Sign is cancer
        JSONObject signCancerDetails = new JSONObject();
        signCancerDetails.put("date_range"," 06.21 - 07.22 ");
        signCancerDetails.put("information","Strengths: Tenacious, highly imaginative, loyal, emotional, sympathetic, persuasive. Weaknesses: Moody, pessimistic, suspicious, manipulative, insecure. Cancer likes: Art, home-based hobbies, relaxing near or in water, helping loved ones, a good meal with friends\n" +
        ...
        signCancerObject.put("cancer",signCancerDetails);
        ...
        signLeoObject.put("leo",signLeoDetails);

        // 8 Sign is virgo
        JSONObject signVirgoDetails = new JSONObject();
        signVirgoDetails.put("date_range","08.23 – 09.22 ");
        signVirgoDetails.put("information","Strengths: Loyal, analytical, kind, hardworking, practical. Weaknesses: Shyness, worry, overly critical of self and others, all work and no play. Virgo likes: Animals, healthy food, books, nature, cleanliness.Virgo dislikes: Rudeness, asking for help, taking center stage\n" +
        ...
        signVirgoObject.put("virgo",signVirgoDetails);

        // 9 Sign is libra
        JSONObject signLibraDetails = new JSONObject();
        signLibraDetails.put("date_range","09.23 - 10.22 ");
        signLibraDetails.put("information","Strengths: Cooperative,diplomatic, gracious, fair-minded, social. Weaknesses: Indecisive, avoids confrontations, will carry a grudge, self-pity. Libra likes: Harmony, gentleness, sharing with others, the outdoors.Libra dislikes: Violence, injustice, loudmouths, conformity\n" +
        ...
        signScorpioObject.put("scorpio",signScorpioDetails);

        // 11 Sign is sagittarius
        JSONObject signSagittariusDetails = new JSONObject();
        signSagittariusDetails.put("date_range"," 11.22 - 12.21  ");
        signSagittariusDetails.put("information","Strengths: Generous, idealistic, great sense of humor. Weaknesses: Promises more than can deliver, very impatient, will say anything no matter how undiplomatic.Sagittarius likes: Freedom, travel, philosophy, being outdoors\n" +
        ...
        signSagittariusObject.put("sagittarius",signSagittariusDetails);

        // 12 Sign is capricorn
        JSONObject signCapricornDetails = new JSONObject();
        signCapricornDetails.put("date_range"," 12.22 - 12.31 ");
        signCapricornDetails.put("information","Strengths: Responsible, disciplined, self-control, good managers. Weaknesses: Know-it-all, unforgiving, condescending, expecting the worst. Capricorn likes: Family, tradition, music, understated status, quality craftsmanship\n" +
        ...
        signCapricornObject.put("capricorn",signCapricornDetails);
        ...
        signCapricornsObject.put("capricorns",signCapricornsDetails);
